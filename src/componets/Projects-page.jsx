...
const ProjectsPage = () => {
  ...
  <div className="flex flex-col overflow-y-scroll max-w-full h-[85vh]">
    ...
    <div className="ml-8 grid space-y-6 text-slate-300 mt-10 pb-32">
      ...
      <h2 className="text-slate-300 font-bold">Using JS Libraries</h2>
      ...
      {/* Using C Projects */}
      <h2 className="text-slate-300 font-bold text-base">Using C</h2>

      {/* Scientific Calculator */}
      <span className="w-full">
        <p className="mb-3 font-semibold text-sky-500 text-base">1. Scientific Calculator</p>
