...
const Home = () => {
  ...
  return (
    <div className={`h-screen w-screen bg-slate-900 ${isChat ? "fixed":""}  `}>
      <div className=" ">
        <Navbar />
      </div>
            ...
            <div className="lg:overflow-y-scroll h-[40rem] ">
              <div className="flex flex-col gap-6 justify-center items-center md:items-start  h-auto min-h-[40rem] lg:pt-56">
                ...
                <p className="text-slate-50  text-sm sm:text-md md:text-lg lg:text-xl flex-wrap py-2  md:max-w-xl">
                  Building creative and functional digital experiences with code
                  and design. I transform ideas into reality through innovation
                  and dedication.
                </p>
                ...
                <div className="text-slate-50 flex-wrap py-2 w-[96%]  md:max-w-xl flex flex-col items-center gap-6 h-auto pb-36 mb-6 text-[12px] sm:text-base ">
                  <span className="autoshow w-full ">
                    ...
                    real-world problems. I enjoy exploring how data can unlock
                    insights, tell compelling stories, and drive better
                    decisions.
                  </span>
                
                  <span className="autoshow w-full">
                    <p className="font-bold mb-3 text-sky-500 text-base ">Introduction</p>I am a passionate
                    web developer with a strong foundation in front-end and
                    back-end technologies. My journey in web development has
                    been driven by a love for creating dynamic, user-friendly,
                    and visually appealing websites.
                  </span>
                  <span className="autoshow w-full ">
                    <p className="font-bold mb-4 text-sky-500 text-base">Skills and Technologies</p>
                    <div className="  flex gap-2 mx-8 text-slate-200 flex-wrap">
                      <p className="text-slate-50">Front-end:</p> HTML5, CSS3,
                      JavaScript, React.js, Tailwind
                    </div>
                    <div className="  flex gap-2 mx-8 text-slate-200">
                      <p className="text-slate-50">Back-end:</p> Node.js  <span className="animate-pulse text-yellow-500">( learning )</span>
                    </div>
                    <div className="  flex gap-2 mx-8 text-slate-200">
                      <p className="text-slate-50">Databases:</p> MySQL, MongoDB <span className="animate-pulse text-yellow-500">( learning )</span> 
                    </div>
                    <div className="  flex gap-2 mx-8 text-slate-200">
                      <p className="text-slate-50">Other Tools: </p> Git,
                      GitHub,  VS Code  <span className="animate-pulse text-yellow-500">( learning )</span>
                    </div>
                  </span>
                  <span className="">
                    <h1 className="autoshow w-full mb-5 font-semibold text-pink-500 text-xl">Projects</h1>

                    <div className="ml-8  grid space-y-6">
                      <span className="autoshow w-full">
                        <p className="mb-3 font-semibold text-sky-500 flex  items-center gap-2 text-base ">1 . Portfolio Website  <span className="after:animate-ping relative after:absolute  after:w-2 after:h-2 flex items-center justify-center after:rounded-full after:bg-green-500 w-2 h-2 rounded-full bg-green-500"></span></p>
                      ...
                      <span className="autoshow w-full ">
                        ...
                        <p className="ml-4 mt-2 grid space-y-1">
                          <span>
                            {" "}
                            Developed a full-stack web application for Music.
                          </span>
                          <span>
                            Includes features like responsive design , liked
                            music , history.
                          </span>
                          <span>
                            {" "}
                      ...
                      <span className="autoshow w-full ">
                        ...
                        <p className="ml-4 mt-2 grid space-y-1">
                          ...
                          <span>
                          Includes features like product filtering, user authentication, and a shopping cart.
                          </span>
                          <span>
                            {" "}
                      ...
                      <span className="autoshow w-full ">
                        ...
                        <p className="ml-4 mt-2 grid space-y-1">
                          <span>
                            {" "}
                            Developed a full-stack web application for Real time chatting application between users.
                          </span>
                          <span>
                          Includes features like Group and personal chat.
                          </span>
                          <span>
